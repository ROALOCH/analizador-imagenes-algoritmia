...
namespace iP_Etapa2{
    public class Circle{
        ...
        public string showInfo() { 
            return "Círculo N. " + iD + ", Centro (" + center.X + ", " + center.Y + "), Radio: " + radiusH + " pixeles";
        }
        ...
        public bool eraseShape(Bitmap b, Bitmap nO){
            int up;
            int down;
            bool flag = false;
